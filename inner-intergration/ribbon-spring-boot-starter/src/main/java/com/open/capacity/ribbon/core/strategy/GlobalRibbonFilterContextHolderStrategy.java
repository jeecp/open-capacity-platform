 ...
 * <p>
 * This means that all instances in the JVM share the same <code>RibbonFilterContex</code>.
 * This is generally useful with rich clients, such as Swing.
 *
 * @author Ben Alex
 */
public class GlobalRibbonFilterContextHolderStrategy implements RibbonFilterContextHolderStrategy {
	// ~ Static fields/initializers
	// =====================================================================================

	private static RibbonFilterContext contextHolder;
	...
	public RibbonFilterContext getContext() {
		if (contextHolder == null) {
			contextHolder = new DefaultRibbonFilterContext() ;
		}
