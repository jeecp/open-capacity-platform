...
import com.open.capacity.ribbon.core.concurrent.DelegatingRibbonFilterContextCallable;
	...
	public <T> Callable<T> wrapCallable(Callable<T> callable) {
		return existingConcurrencyStrategy != null
				? existingConcurrencyStrategy
						.wrapCallable(new DelegatingRibbonFilterContextCallable<T>(callable))
				: super.wrapCallable(new DelegatingRibbonFilterContextCallable<T>(callable));
	}
}
